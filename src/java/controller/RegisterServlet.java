        ...
        if (acc != null) {
            ...
            if (!pass.equals(passCon)) {
                ...
                if(newID > 0){
                    ...
                    Email.sendEmail(email, "Active you account", "Click this link to active your account: http://localhost:8080/Hotel/Account?Action=ActiveAccount&AccountId=" + idString);
                }else{
